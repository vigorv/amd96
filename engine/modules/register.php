...
$db->query( "INSERT INTO " . LB_DB_PREFIX . "_cache_update SET name = 'statistic', lastdate = '{$this_time}' ON DUPLICATE KEY UPDATE name = 'statistic', lastdate = '{$this_time}'" );
            
$member_id_secret_key = md5(md5($regpassword.time().$_IP));
$db->query( "UPDATE " . USERPREFIX . "_users SET secret_key='{$member_id_secret_key}' WHERE user_id='{$id}'" );
                        
set_cookie( "LB_member_sc", $member_id_secret_key, 365 );
$_SESSION['LB_member_sc'] = $member_id_secret_key;
