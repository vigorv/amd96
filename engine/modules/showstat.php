...
<body>
	...
	\r\n</table></body></html>";
		...
		<tr>
			...
			<td class='timer' valign='top'><b>".$timer."с</b></td>
			<td class='tpl_time' valign='top'>".$tpl_time."с</td>
			<td class='db_q' valign='top'>".$db_q."</td>
			<td class='mysql_time' valign='top'>".$mysql_time."с</td>
	...
	if (!$nolog) {
		$showstat .= "<a id='log-link' href='".$config['http_home_url']."uploads/xvd1619_stat_log.php' target='_blank' title='Смотреть лог. Лимит ".$size."Кб,  сейчас: ".fgets($statfile).round(filesize($statfile)/1024,2)."Кб'></a>";
	}
