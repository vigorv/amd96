...
<tr><td colspan="2">
 ...
 <div id="rss_panel">
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="300">{rss_gr}</td>
...
<table cellpadding="" cellspacing="0" width="98%" align="center">
<tr>
   <td colspan="4" align="center"  style="padding:6px; border-bottom:1px dashed #c4c4c4;  border-top:1px dashed #c4c4c4"><center>Шаблон захвата фрагмента</center></td>
  </tr>
  <tr>
   <td width="17%" align="center" valign="middle"  style="padding:4px">что захватывать</td>
   <td width="83%" style="padding:4px">{BB_code}<textarea onclick="setFieldName(this.name)" class="load_img" style="width:79%; height:100px" name="zhv_code">{zhv-code}</textarea>
      <a href="#" class="hintanchor" onMouseover="showhint('Полученую информацию можно будет использовать в заменах спец тегом {frag}', this, event, '400px')">[?]</a>
   </td>
   </tr>
</table>
