...
<tr><td colspan="2">
 ...
 <div id="rss_panel">
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    ...
    <td style="padding:4px"><input type="text"  size="70" name="rss_url" value="{address}">
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    <td style="padding:4px" width="300">{rss_description}:</td>
...
<a href="#" class="hintanchor" onMouseover="showhint('{help_catsp}', this, event, '360px')">[?]</a>
  ...
  <tr>
            <td height="29" style="padding-left:5px;"><b>{kats}:</b><i><br><font color="green">http://site.ru/soft</font><b>==</b><font color="red">Софт</font><br>
<font color="green">http://site.ru/film</font><b>==</b><font color="red">Фильмы, Комедии</font></i></td>
      <td style="padding:4px">
      <textarea name="kategory" class="load_img" style="width:388px;height:70px;">{kategory}</textarea>
         <a href="#" class="hintanchor" onMouseover="showhint('{help_kats}', this, event, '360px')">[?]</a>
	</td>
  </tr>
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px" width="300">{add_auto}</td>
   <td style="padding:4px">
    <select name="auto" class="load_img">
     {allow-auto}
    </select>
   <a href="#" class="hintanchor" onMouseover="showhint('{help_add_auto}', this, event, '280px')">[?]</a>
   </td>
  </tr>

  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px" width="300">{cronauto}:</td>
   <td style="padding:4px"><input type="text"  size="15" name="cron_auto" value="{cron-auto}">
  <a href="#" class="hintanchor" onMouseover="showhint('{help_cronauto}', this, event, '420px')">[?]</a>
   </td>
  </tr>
...
<tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
 ...
 <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="300">{folder_pics}</td>
...
<a href="#" class="hintanchor" onMouseover="showhint('{help_dimsait}', this, event, '420px')">[?]</a>
   {dimcat}   
...
{dop_watermark}  
   ...
   <a href="#" class="hintanchor" onMouseover="showhint('{help_dop_watermark}', this, event, '420px')">[?]</a>
{wathost}  
  ...
  <tr >
    <td style="padding:4px" style="border-top:1px dashed #c4c4c4" >{title_start_word}</td>
    <td style="padding:4px"><input type="text" size="30" name="s_title" value="{s-title}">  
    </td>
  </tr>

  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    <td style="padding:4px" >{title_end_word}</td>
    <td style="padding:4px"><input type="text" size="30" name="end_title" value="{end-title}">  
    </td>
  </tr>
  ...
  <tr>
   <td style="padding:4px"  width="304">Переводчик:</td>
   <td style="padding:4px">
   ...
   <a href="#" class="hintanchor" onMouseover="showhint('Перевод новостей с помощью переводчика Google', this, event, '420px')">[?]</a>
  </td>
  </tr>
    ...
    <tr>
        <td width="140" height="29" style="padding-left:5px;">{catalog_grab}</td>
        <td style="padding:4px"><input type="text" name="symbols" size="5"  class="load_img" value="{symbol}"><a href="#" class="hintanchor" onMouseover="showhint('{help_catalog_grab}', this, event, '300px')">[?]</a>
    ...
    <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
        ...
        <td style="padding:4px"><input type="text" name="tags" size="62"  class="load_img" value="{tags}"><a href="#" class="hintanchor" onMouseover="showhint('{help_tags_lenta}', this, event, '300px')">[?]</a></td>
    </tr>
   ...
   <select name="deap" class="load_img">
    {deap}
	    ...
	    <tr>
	        ...
	        <td style="padding:4px"><input type="text" name="meta_title" style="width:388px;" class="load_img" value="{meta-title}">  {auto_meta_title}  <select name="auto_metatitle" class="load_img">
     {auto-metatitle}
    </select></td>
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="304">Генерировать описание:</td>
   <td style="padding:4px"><select name="descr_sel" class="load_img">{descr-sel}</select></td>
  </tr>

	    <tr>
	        <td height="29" style="padding-left:5px;">{meta_descr_grab}:<br><i>(будет одинаковое для всех новостей)</i></td>
	        <td style="padding:4px"><textarea name="meta_descr" class="load_img" style="width:388px;height:70px;">{meta-descr}</textarea></td>
	    </tr>

  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="304">Генерировать ключевые слова:</td>
   <td style="padding:4px"><select name="keyw_sel" class="load_img">{keyw-sel}</select></td>
  </tr>

	    <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
	        <td height="29" style="padding-left:5px;">{meta_keys_grab}:<br><i>(будут одинаковые для всех новостей)</i></td>
  ...
  <!-- Шаблоны -->
   ...
   <table cellpadding="" cellspacing="0" width="98%" align="center">
   <tr>
   <td colspan="2" style="padding:6px; border-bottom:1px dashed #c4c4c4;  border-top:1px dashed #c4c4c4" class="navigation"><b>Шаблон полной новости</b></td>
  </tr>
  <tr>
   <td style="padding:4px" valign="top" class="navigation">Начало шаблона:</td>
   <td style="padding:4px"><textarea class="edit" rows="8" cols="60" name="start_template">{start-template}</textarea>
      <a href="#" class="hintanchor" onMouseover="showhint('Начало шаблона - это любой html текст который обозначает начало новости', this, event, '400px')">[?]</a>
   </td></tr>
  <tr>
   <td style="padding:4px" valign="top" class="navigation">Конец шаблона:</td>
   <td style="padding:4px"><textarea class="edit" rows="8" cols="60" name="finish_template">{end-template}</textarea>
   <a href="#" class="hintanchor" onMouseover="showhint('Конец шаблона - это любой html текст который обозначает конец новости', this, event, '400px')">[?]</a>
   </td>
  </tr>
  </table>
   ...
   <table cellpadding="" cellspacing="0" width="98%" align="center">
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    <td style="padding:4px" >{dops_full}</td>
...
{xfields-template}
  ...
  <tr>
   <td style="padding:8px; border:1px solid #c4c4c4; background-color:#fafafa;">
      Чтобы задать начальные и конечные шаблоны нужно:<br/><br/>
      1. Открыть нужный канал в Internet Explorer и найти ссылку на полную новость (Обычно в теге &lt;link&gt;)<br/>
      2. Перейти по полученный ссылке и открыть HTML код страницы<br/>
      3. Определить любой уникальный текст определяющий начало новости и конец новости и заполнить в шаблоны<br/><br/>

      К примеру шаблоны для сайта pc-soft.ru (это относится к большинству сайтам на движке DataLife Engine):<br/><br/>

      Начало: &lt;div id='news-id-<br/><br/>
...
{rekl_fulltstory}
  ...
  <!-- Фильтр, Авторизация -->
   ...
   <table cellpadding="" cellspacing="0" width="98%" align="center">
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="304">Использовать Логин и Пароль:</td>
   <td style="padding:4px">
   <select name="log_pas" class="load_img">
    {log-pas}<div style="display:none;"><a href="http://www.vsest.com/">Vsest Все есть музыка, фильмы и программы</a></div>
   </select>
   </td>
  </tr>
  ...
  <tr>
   <td style="padding:4px" valign="top" >Cookies</td>
   <td style="padding:4px">
  ...
  <tr>
   <td colspan="2" style="padding:4px; border-bottom:1px dashed #c4c4c4;  border-top:1px dashed #c4c4c4" >{keyword}</td>
  </tr>
  <tr>
   <td style="padding:4px" valign="top" >Keywords</td>
...
<tr>
   <td colspan="2" style="padding:4px; border-bottom:1px dashed #c4c4c4;  border-top:1px dashed #c4c4c4" >{stop_keyword}</td>
  </tr>
  <tr>
   <td style="padding:4px" valign="top" > Stop keywords</td>
...
<!-- Конец -->
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    <td style="padding:4px" >{templates_page}</td>
    <td style="padding:4px"><input type="text"  size="100" name="full_link" value="{full-link}">
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    ...
    <td style="padding:4px"><input type="text"  size="10" name="step_page" value="{step-page}"><a href="#" class="hintanchor" onMouseover="showhint('{help_steppage}', this, event, '400px')">[?]</a></td>
  </tr>

  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    <td style="padding:4px">{start_page}</td>
    <td style="padding:4px"><input type="text"  size="10" name="so" value="{so}"></td>
  </tr>

  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
    <td style="padding:4px">{end_page}</td>
    <td style="padding:4px"><input type="text"  size="10" name="po" value="{po}"></td>
  </tr>
...
<tr>
  ...
  <tr align="center">
   <td style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="ful_start">{ful-start}</textarea>
...
<tr align="center">
  ...
  <tr align="center">
   <td style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="start_title">{start-title}</textarea>
...
<tr align="center">
  ...
  <tr align="center">
   <td style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="sart_link">{sart-link}</textarea>
...
<tr align="center">
  ...
  <table cellpadding="" cellspacing="0" width="98%" align="center">
<tr align="center">
   <td style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="start_short">{start-short}</textarea>
...
<tr>
  ...
  <tr align="center">
   <td style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="sart_cat">{sart-cat}</textarea>
...
<tr>
  ...
  <tr align="left">
   ...
   <td width="83%" style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="s_del">{s-del}</textarea>
...
<tr align="left">
   ...
   <td width="83%" style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="end_del">{end-del}</textarea>
...
<tr>
  ...
  <tr align="left">
   ...
   <td width="83%" style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="delate">{delate}</textarea>
...
<tr align="left">
   ...
   <td width="83%" style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="inser">{inser}</textarea>
...
<tr>
  ...
  <tr>
   ...
   <td width="83%" style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="start">{start}</textarea>
...
<tr>                                                        
   ...
   <td width="83%" style="padding:4px"><textarea class="load_img" rows="4" cols="100" name="finish">{finish}</textarea>
