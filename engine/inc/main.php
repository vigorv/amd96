...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/uset.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=editusers&action=list"><h3>{$lang['opt_user']}</h3>
        </a></div></td>
    </tr>
</table>
</td>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/ads.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=banners"><h3>{$lang['opt_banner']}</h3>
        </a></div></td>
    </tr>
</table>
</td>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/tools.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=options&action=syscon"><h3>{$lang['opt_all']}</h3>
        </a></div></td>
    </tr>
</table>
</td>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/nset.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=newsletter"><h3>{$lang['main_newsl']}</h3>
        </a></div></td>
    </tr>
</table>
</td>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/spset.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=static"><h3>{$lang['opt_static']}
        </h3>
        </a></div></td>
    </tr>
</table>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/clean.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=clean"><h3>{$lang['opt_clean']}</h3>
        </a></div></td>
    </tr>
</table>
</td>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/shield.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a onclick="check_files('lokal'); return false;" href="#"><h3>{$lang['mod_anti']}</h3>
        </a></div></td>
    </tr>
</table>
        <td>
...
<table width="100%">
    <tr>
        <td width="40" height="40" valign="middle" align="center" style="padding-top:5px;padding-bottom:5px;"><img src="engine/skins/images/next.png" height="30" width="30" border="0"></td>
        <td valign="middle"><div class="quick"><a href="$PHP_SELF?mod=options&action=options"><h3>{$lang['opt_all_rublik']}</h3>
        </a></div></td>
    </tr>
</table>
