...
<table width="100%">
    <tr>
        <td bgcolor="#EFEFEF" height="29" style="padding-left:10px;"><div class="navigation">{$lang['opt_edteil']} <b>{$do_template}</b> {$lang['templates_help']} <a class="main" href="http://dlekey.cn/extras/online/all2.html" target="_blank">http://dlekey.cn/extras/online/all2.html</a></div></td>
    </tr>
</table>
<div class="unterline"></div>
<table width="100%">
