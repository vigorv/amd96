...
<table width="100%">
    ...
    <tr>
        <td width="140" height="29" style="padding-left:5px;">title2</td>
        <td><input class="edit bk" type="text" style="width:350px;" name="title2" id="title2"></td>
    </tr>
    <tr>
...
<div class="hr_line"></div>
            ...
            <td height="29" width="140" style="padding-left:5px;">Data</td>
                    <td><a href="{$config['service_uri']}site/upload" class="btn" target="_blank" onClick="addData(); return false;">Добавить ссылки </a></td>
                    </tr>
                    </table>
