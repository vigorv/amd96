...
require_once ENGINE_DIR . '/modules/logicboard/functions.php';
///forum
...
########ZONES##########
require_once ENGINE_DIR . '/modules/rumedia/rumedia.funcs.php';
$zone = getZone();
#######ZONE######
...
$metatags = array (
				...
				'header_title' => "" );
//forum
include (ENGINE_DIR . '/modules/logicboard/cache.php');
///forum
...
//forum
$tpl->set( '{lb_options_link}', LB_profile_edit_link($member_id['name'], "options") );
$tpl->set( '{lb_status_link}', LB_profile_edit_link($member_id['name'], "status") );
$tpl->set( '{lb_favorites_link}', LB_member_favorite() );
$tpl->set( '{lb_subscribe_link}', LB_member_subscribe() );
///forum
...
//forum
require_once ENGINE_DIR . '/modules/logicboard/online.php';
//forum
