...
<h3>[is_forum]Подфорумы: [/is_forum][is_category]Подфорумы категории: [/is_category]{category_name}<i></i><span class="co co5"><span class="tr"></span><span class="br"></span></span></h3>
<div class="cat_list">
<ol>
[/category_header]
[forum]
    <li class="cl_item">
        ...
        <img src="{TEMPLATE}/forum_icons/{forum_img}" width="33" height="30" alt="" class="f_icon" title="{forum_status}" />
        {forum_desc}
