...
$link_speddbar = "<a href=\"".$redirect_url."?do=configuration\">Настройки</a>|Удаление настройки";
$control_center->header("Настройки", $link_speddbar);
$onl_location = "Настройки &raquo; Удаление настройки";
...
if ($id)
{
	...
	if ($confdel['conf_id'] AND !$confdel['conf_protect'])
	{
		...
		$cache->clear("", "config");
		$info = "<font color=red>Удаление</font> настройки: ".$DB->addslashes($confdel['conf_name']);
	...
	{
		$control_center->errors[] = "Выбранная настройка не найдена в базе данных. Возможна она была удалена или вы ошиблись.";
...
{
	$control_center->errors[] = "Вы не выбрали настройку для удаления.";
	$control_center->errors_title = "Ошибка!";
	$control_center->message();
}
