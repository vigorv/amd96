...
<input class="bnt" style="font-size: 11px; float: right;" title="Настройка чата" onclick="iChatAdmin(); return false;" type="button" value="Настройка чата" />
<br />&nbsp;
...
<input class="btn" style="font-size: 11px; float: left;" title="Правила" onclick="iChatRules(); return false;" type="button" value="Правила" />&nbsp;
<input class="btn" style="font-size: 11px; float: left;" title="Архив" onclick="iChatHistory(); return false;" type="button" value="Архив" />&nbsp;
<input class="btn" style="font-size: 9px; float: right;" title="Отправить" onclick="iChatAdd('site'); return false;" type="button" value="Отправить" />
</div>
