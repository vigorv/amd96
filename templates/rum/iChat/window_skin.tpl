...
<div align="right" style="font-size: 9px; padding-right: 3px;">напишу еще</div>
...
<input class="three_but-one" style="font-size: 11px; float: left;" title="Правила" onclick="iChatRules(); return false;" type="button" value="Правила" />&nbsp;
<input class="three_but-one" style="font-size: 11px; float: left;" title="Архив" onclick="iChatHistory(); return false;" type="button" value="Архив" />&nbsp;
<input class="three_but-one" style="font-size: 9px; float: right;" title="Отправить" onclick="iChatAdd('site'); return false;" type="button" value="Отправить" />
</div>
