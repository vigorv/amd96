<div style="clear: both; height: 7px;"></div>
	<div style="background: #404040; margin-left: 9px; padding: 5px; width: 955px; border: 2px solid #999999; border-radius: 5px;">
	...
	<div id="iChat-style" class="scroll-pane" style="width:max;height: 500px; overflow:auto;">
	...
	<div style="padding-top:12px;">
		...
		<input class="btn" style="height: 25px; line-height: 11px; float: right;" title="Отправить" onclick="iChatAdd('window'); return false;" type="button" value="Отправить" />
	</div>
