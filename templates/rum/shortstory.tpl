...
<div class="main-news-all">
    ...
    [xfgiven_poster4full]<div class="main-news-image"><a href="[xfvalue_poster4full]" onclick="return hs.expand(this)"><span class="main-news-img-fon"><img src="{image-1}" alt="{title}" /></span></a></div>[/xfgiven_poster4full]
    [xfnotgiven_poster4full]<div class="main-news-image">[full-link]<span class="main-news-img-fon"><img src="{image-1}" alt="{title}" /></span>[/full-link] </div>[/xfnotgiven_poster4full]
